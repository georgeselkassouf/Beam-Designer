...
def design(event):
    ...
    if unitbox.get() == units[0]:
        ...
        ksi1 = Label(root, text= "Ksi", font = 'Calibri 11', fg = 'black')
        ksi1.place(x=95, y =70)

        ksi2 = Label(root, text= "Ksi", font = 'Calibri 11', fg = 'black')
        ksi2.place(x=95, y =100)

        inch1 = Label(root, text= "in", font = 'Calibri 11', fg = 'black')
        inch1.place(x=95, y =130)

        inch2 = Label(root, text= "in", font = 'Calibri 11', fg = 'black')
        inch2.place(x=95, y =160)

        inch3 = Label(root, text= "in", font = 'Calibri 10', fg = 'black')
        inch3.place(x=182, y =288)

        inch4 = Label(root, text= "in", font = 'Calibri 10', fg = 'black')
        inch4.place(x=182, y =318)

        inch5 = Label(root, text= "in", font = 'Calibri 10', fg = 'black')
        inch5.place(x=182, y =348)
        ...
        insquare1 = Label(root, text= "in\u00B2", font = 'Calibri 10', fg = 'black')
        insquare1.place(x=184, y =450, anchor = CENTER)

        insquare2 = Label(root, text= "in\u00B2", font = 'Calibri 10', fg = 'black')
        insquare2.place(x=459, y =450, anchor = CENTER)

        insquare3 = Label(root, text= "in\u00B2", font = 'Calibri 10', fg = 'black')
        insquare3.place(x=459, y =420, anchor = CENTER)

        insquare4 = Label(root, text= "in\u00B2", font = 'Calibri 10', fg = 'black')
        insquare4.place(x=184, y =420, anchor = CENTER)
